...
- [Creational design patterns - Singleton](#creational-design-patterns---singleton)
    - [Key terms](#key-terms)
...
## Reading list
* [Singleton pattern - Different implementations](https://www.baeldung.com/java-singleton)